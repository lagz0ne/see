...
and `fontSize` (`--font-size-base`), two pages (`index.html`, `pricing.html`), and no
...
6. Claim the friendly name `acme-store`; confirm the new id resolves and the old one 404s.
